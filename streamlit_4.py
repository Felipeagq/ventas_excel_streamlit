...
with st.sidebar:
    ...
    st.divider()
    st.header("Gráficas")
    mostrar_vendedor = st.checkbox("Ventas por Vendedor", value=True)
    mostrar_region = st.checkbox("Ventas por Región", value=True)
    mostrar_mes = st.checkbox("Ventas por Mes", value=True)
...
with col1:
    regiones = st.multiselect("Región", df["Region"].unique(), default=df["Region"].unique())
with col2:
    vendedores = st.multiselect("Vendedor", df["Vendedor"].unique(), default=df["Vendedor"].unique())
with col3:
    meses = st.multiselect("Mes", df["Mes"].unique(), default=df["Mes"].unique())
